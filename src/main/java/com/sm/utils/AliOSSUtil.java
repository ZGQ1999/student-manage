...
public class AliOSSUtil {
    ...
    public static String ossUpload(File file) {
        String bucketDomain = "https://koala2.oss-cn-shanghai.aliyuncs.com/";
        //Endpoint以北京为例，其它Region请按实际情况填写
        String endpoint = "http://oss-cn-shanghai.aliyuncs.com";
        //accessKeyId和accessKeySecret，请填写自己的
        String accessKeyId = "LTAIY0Ihij5qSC9E";
        String accessKeySecret = "EeAtchwljaIF3PtM7zrO8g6224NXeZ";
        //Bucket名称
        String bucketName = "koala2";
        //目录名称
        String filedir = "img/";
        //获得本地文件的文件名
